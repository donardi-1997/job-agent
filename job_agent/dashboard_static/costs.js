(() => {
  ...
  function ensurePanel() {
    ...
    panel.innerHTML = `
      <div class="ai-usage-heading"><div><p class="eyebrow">COSTO DE IA</p><h2>Consumo del agente en pesos colombianos</h2><p>COP es la moneda principal del panel. Conservamos USD como referencia técnica porque los proveedores facturan en dólares.</p><div class="ai-rate" id="aiRate">Tasa USD/COP: cargando…</div></div><span class="safe-pill">COP</span></div>
